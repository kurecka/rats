...
void register_manhattan(py::module &m, const T& env_type) {
    py::class_<manhattan>(m, "Manhattan", env_type)
        .def(py::init<std::vector< std::string >, std::string, std::map< std::string, float >, float, float, float >(),
             py::arg("targets"), py::arg("init_state"), py::arg("periods"), py::arg("capacity"), py::arg("cons_thd") = 10.0f, py::arg("radius") = 2.0f)
