...
class AEVEnv:
    ...
    def create_consmdp(self):
        ...
        # create states in the mdp, they are stored as numbers (indices)
        # mapping labels to indices is done thru cmdp.state_with_name(label)
        for s in states:
        ...
        # actions stores a dict of dicts
        # indexed by state labels
        # the snd level dict maps keys "from", "cons", "dist"
        # from maps to a 
