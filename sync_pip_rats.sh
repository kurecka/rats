...
python3 raylite cmd /var/data/${USER}/rats/ray_launch.yaml "docker cp /var/data/${USER}/rats/build/rats.so ray_container:/home/ray/anaconda3/lib/python3.8/site-packages/rats.cpython-38-x86_64-linux-gnu.so"
